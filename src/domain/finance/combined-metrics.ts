...
export const COMBINED_METRICS: Record<CombinedMetricKey, CombinedMetricSpec> = {
  totalInflow: {
    ...
    isMoney: true,
    recordsPath: (slug) => `/operations/${slug}/inflow`,
  },
  totalOutflowDue: {
    key: "totalOutflowDue",
    ...
    isMoney: true,
    recordsPath: (slug) => `/operations/${slug}/outflow`,
  },
  outflowPaid: {
    key: "outflowPaid",
    label: "Outflow Paid",
    ...
    isMoney: true,
    recordsPath: (slug) => `/operations/${slug}/outflow?status=PAID`,
  },
  outflowPending: {
    key: "outflowPending",
    ...
    isMoney: true,
    recordsPath: (slug) => `/operations/${slug}/outflow?status=unpaid`,
  },
  receivables: {
    key: "receivables",
    label: "Receivables",
    ...
    isMoney: true,
    recordsPath: (slug) => `/operations/${slug}/inflow?status=unpaid`,
  },
  netPosition: {
    key: "netPosition",
    label: "Net Position",
