...
export default async function InflowMonthPage({
  ...
  const columns: GridColumn[] = [
    ...
    { field: "amount", label: `Deal Value (${cur})`, type: "money", width: "w-40" },
    { field: "paidAmount", label: `Amount Received (${cur})`, type: "money", width: "w-40" },
    { field: "balance", label: `Balance Due (${cur})`, type: "derived", width: "w-40" },
