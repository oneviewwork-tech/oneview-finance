...
export default async function OutflowMonthPage({
  ...
  const columns: GridColumn[] = [
    ...
    { field: "amount", label: `Amount Due (${cur})`, type: "money", width: "w-40" },
    { field: "paidAmount", label: `Amount Paid (${cur})`, type: "money", width: "w-40" },
    { field: "payFull", label: "Pay Full?", type: "select", width: "w-24", options: PAY_FULL_CHOICES },
    { field: "balance", label: `Balance (${cur})`, type: "derived", width: "w-40" },
